...
class ResNet50_CIFAR10(nn.Module):
    def __init__(self, num_classes=10):
        ...
        # CIFAR-10 是 32x32，小圖不適合原本 7x7 stride=2
        ...
        # CIFAR-10 不建議一開始就做 maxpool，會掉太多資訊
...
if __name__ == "__main__":
    ...
    # 輸出路徑
    best_model_path = "best_resnet50_cifar10.pth"
    predict_save_dir = "resnet50_predict_results"
    confusion_matrix_path = "resnet50_confusion_matrix.png"
